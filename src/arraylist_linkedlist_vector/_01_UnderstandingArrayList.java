...
public class _01_UnderstandingArrayList {
    public static void main(String[] args) {
        ...
        //1.Declaring an array vas an Arraylist
        ...
        System.out.println("Tha array =" + Arrays.toString(names1)); // [null , null , null ]
        ...
        System.out.println("\n -----Printing array vs ArrayList-----\n");
        System.out.println("Tha array =" + Arrays.toString(names1)); // [Alex , null , null ]
 ...
 */
        ...
        System.out.println("\n -----Printing array vs ArrayList-----\n");
        System.out.println("Tha array =" + Arrays.toString(names1));// [Alex, Ali, Andrii]
     ...
     */
        ...
        names1[1] = "Mike";
        names2.set(1, "Olena");
        System.out.println("Tha array =" + Arrays.toString(names1));// [Alex, Mike, Andrii]
